...
then
  ...
  $uid=</root/uid
  $keyfile_encrypted=</root/tmpramfs/keyfile_encrypted
  wget -q https://installer.optimus-avocats.fr/autodecryptor/index.php --post-data="uuid=$uid&keyfile=$keyfile_encrypted"
