...
then
  ...
  verbose chown -R debian:debian /srv/cloud
  verbose cd /srv/cloud
  verbose sudo -u debian /srv/cloud/composer.phar require sabre/dav ~3.2.0
  verbose chown -R www-data:www-data /srv/cloud;
