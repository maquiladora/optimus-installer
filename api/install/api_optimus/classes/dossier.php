...
class dossier
{
  ...
  function rename($data)
  {
    ...
    @rename('/srv/mailboxes/prime@demoptimus.fr/==DOSSIERS==/' . $old_name['nom'], '/srv/mailboxes/prime@demoptimus.fr/==DOSSIERS==/' . mb_convert_encoding($data->new_name, "UTF7-IMAP","ISO-8859-15"));
