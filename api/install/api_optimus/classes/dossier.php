...
class dossier
{
  ...
  function rename($data)
  {
    ...
    @rename('/srv/mailboxes/prime@demoptimus.fr/==DOSSIERS==/' . mb_convert_encoding($old_name['nom'], "UTF7-IMAP","ISO-8859-15"), '/srv/mailboxes/prime@demoptimus.fr/==DOSSIERS==/' . mb_convert_encoding($data->new_name, "UTF7-IMAP","ISO-8859-15"));
    $subscriptions = file_get_contents('/srv/mailboxes/prime@demoptimus.fr/subscriptions');
    $subscriptions = str_replace('==DOSSIERS==/' . mb_convert_encoding($old_name['nom'], "UTF7-IMAP","ISO-8859-15"), '==DOSSIERS==/' . mb_convert_encoding($data->new_name, "UTF7-IMAP","ISO-8859-15"), $subscriptions);
