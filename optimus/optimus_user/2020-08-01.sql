...
CREATE TABLE IF NOT EXISTS `contacts` (
  ...
  `type` tinyint(4) unsigned NOT NULL DEFAULT 30,
  `title` tinyint(4) unsigned NOT NULL DEFAULT 0,
  ...
  `birth_country` int(11) unsigned NOT NULL DEFAULT 0,
  `insee` varchar(255) DEFAULT NULL,
  `marital_status` tinyint(4) unsigned NOT NULL DEFAULT 0,
  ...
  `country` int(11) unsigned NOT NULL DEFAULT 74,
  ...
  `categorie` tinyint(4) unsigned DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8mb4;
