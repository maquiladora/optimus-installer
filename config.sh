...
export DOMAIN=
export AES_KEY=
export AUTOGENERATE_AES_KEY=Y
export UUID=
export AUTOGENERATE_UUID=Y
export AUTOGENERATE_PASSWORDS=Y
export LAST_UPGRADE=
...
export MARIADB_ADMIN_PASSWORD_AUTOGENERATE=
