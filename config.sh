...
export MARIADB_ADMIN_USER=postmaster@$DOMAIN
export MARIADB_ADMIN_PASSWORD=postmaster123
export MARIADB_REMOTE_ROOT_PASSWORD=remote_root-123

CLOUD_AREYOUSURE=Y
export CLOUD_MARIADB_USER=cloud
export CLOUD_MARIADB_PASSWORD=cloud123
