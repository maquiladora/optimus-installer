...
verbose mariadb -u root -e "GRANT ALL ON server.mailboxes_acl_anyone TO '$MARIADB_MAIL_USER'@'127.0.0.1' IDENTIFIED BY '$MARIADB_MAIL_PASSWORD';"
verbose mariadb -u root -e "GRANT ALL ON server.mailboxes_domains TO '$MARIADB_MAIL_USER'@'127.0.0.1' IDENTIFIED BY '$MARIADB_MAIL_PASSWORD';"
verbose mariadb -u root -e "GRANT ALL ON server.awl TO '$MARIADB_MAIL_USER'@'127.0.0.1' IDENTIFIED BY '$MARIADB_MAIL_PASSWORD';"
verbose mariadb -u root -e "GRANT ALL ON server.bayes_expire TO '$MARIADB_MAIL_USER'@'127.0.0.1' IDENTIFIED BY '$MARIADB_MAIL_PASSWORD';"
verbose mariadb -u root -e "GRANT ALL ON server.bayes_global_vars TO '$MARIADB_MAIL_USER'@'127.0.0.1' IDENTIFIED BY '$MARIADB_MAIL_PASSWORD';"
verbose mariadb -u root -e "GRANT ALL ON server.bayes_token TO '$MARIADB_MAIL_USER'@'127.0.0.1' IDENTIFIED BY '$MARIADB_MAIL_PASSWORD';"
verbose mariadb -u root -e "GRANT ALL ON server.bayes_vars TO '$MARIADB_MAIL_USER'@'127.0.0.1' IDENTIFIED BY '$MARIADB_MAIL_PASSWORD';"
verbose mariadb -u root -e "GRANT ALL ON server.userpref TO '$MARIADB_MAIL_USER'@'127.0.0.1' IDENTIFIED BY '$MARIADB_MAIL_PASSWORD';"

echo_magenta "Création de la boite mail initiale postmaster@$DOMAIN"
verbose mariadb -u root -e "INSERT IGNORE INTO server.mailboxes VALUES (NULL, 'postmaster@$DOMAIN', '$MARIADB_MAIL_PASSWORD', '0', '1', 'root@$DOMAIN', null, null, null, null);"
