...
then
  ...
  sed -i "s#mysql://username:password@localhost/database/#mysql://$MAILSERVER_MARIADB_USER:$MAILSERVER_MARIADB_PASSWORD@localhost/mailserver" /srv/webmail/plugins/sauserprefs/config.inc.php
