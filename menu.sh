...
tput cup 10 3; echo "f. Installer un espace d'hébergement www \e[0m"
#11 PHP g
#12 MYSQL h
#13 MAIL SERVER i
#14 WEBMAIL j
#15 CLOUD k
tput cup 16 3; if [ -d "/etc/letsencrypt" ]; then echo -ne "\l[32m l. Installer les certificats HTTPS \e[0m"; else echo -ne "\e[31m l. Installer les certificats HTTPS \e[0m"; fi
