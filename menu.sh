...
tput cup 8  3; if blkid /dev/sda2 | grep -q 'crypto_LUKS'; then echo -ne "\e[32m d. Activer le cryptage sur la partition /dev/sda2 \e[0m"; else echo -ne "\e[31m d. Activer le cryptage sur la partition /dev/sda2 \e[0m"; fi
