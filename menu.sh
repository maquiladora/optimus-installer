...
tput cup 8  3; if lsblk -o MOUNTPOINT -n /dev/sda2 | grep -q '/srv'; then echo -ne "\e[32m d. Crypter la partition /dev/sda2 et la monter sur /srv \e[0m"; else echo -ne "\e[31m d. Crypter la partition /dev/sda2 et la monter sur /srv \e[0m"; fi
