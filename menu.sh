...
tput cup 10 3; if [ -d "/srv/www.demoptimus.fr" ];	then echo -ne "\e[32m f. Installer l'espace d'hébergement www \e[0m"; else echo -ne "\e[31m f. Installer l'espace d'hébergement www \e[0m"; fi
