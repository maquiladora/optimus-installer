...
echo '_dmarc.'$DOMAIN' TXT v=DMARC1;p=quarantine;sp=quarantine;pct=100;adkim=r;aspf=r;fo=1;ri=86400;rua=mailto:postmaster@'$DOMAIN';ruf=mailto:postmaster@'$DOMAIN';rf=afrf'
